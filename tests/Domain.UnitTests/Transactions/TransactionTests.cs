...
using MyTicketRemaster.Domain;
using MyTicketRemaster.Domain.Common.ValueObjects.Mass;
using MyTicketRemaster.Domain.Common.ValueObjects.Money;
using MyTicketRemaster.Domain.Exceptions;
using MyTicketRemaster.Domain.Partners;
using MyTicketRemaster.Domain.Products;
using MyTicketRemaster.Domain.Transactions;
...
namespace MyTicketRemaster.Domain.UnitTests.Transactions
{
