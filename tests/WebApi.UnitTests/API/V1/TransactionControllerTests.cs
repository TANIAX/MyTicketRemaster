...
using Moq;
using MyTicketRemaster.Application.Transactions.CreateTransaction;
using MyTicketRemaster.Application.Transactions.GetTransactionDetails;
using MyTicketRemaster.Application.Transactions.GetTransactionsList;
